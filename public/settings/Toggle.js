let Toggle = function (x, y, width, height, leftArg, rightArg, label, position) {
    this.x = x;
    this.y = y;
    this.width = width;
    this.height = height;
...
Toggle.prototype.swap = function () {
    // animate the toggle
...
Toggle.prototype.contains = function (x, y) {
    return (x > this.x && x < this.x + this.width && y > this.y && y < this.y + this.height);
}

Toggle.prototype.setPos = function (x, y) {
    this.x = x;
    this.y = y;
